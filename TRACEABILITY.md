...
| Permutation negative control (physical-block alignment) | `scripts/build_v2_permutation_control.py` | `results/v2_permutation_control_all_viable_min100_full.csv`, `results/v2_permutation_control_all_viable_min100_full_report.md` |
| Seed-pooled significance of feature-set gains | `scripts/build_v2_significance_pooled.py` | `results/v2_significance_pooled_all_viable_min100_full.csv`, `results/v2_significance_pooled_all_viable_min100_full_report.md` |
| Stage-2 agreement features and estimators (label-free comparator; per-seed prediction export gated by `FORECAST_EXPORT_PREDICTIONS=1`, see `scripts/run_eje1_export.ps1`) | `scripts/build_v2_agreement_features.py`, `scripts/build_v2_agreement_estimators.py` | `results/v2_agreement_estimators_all_viable_min100_full.csv`, `results/v2_agreement_estimators_all_viable_min100_full_report.md` (station-level out-of-fold predictions CSV excluded for size; see REPRODUCIBILITY) |
| Significance of agreement-source gains | `scripts/build_v2_agreement_significance.py` | `results/v2_agreement_significance_all_viable_min100_full.csv`, `results/v2_agreement_significance_all_viable_min100_full_report.md` |
| Agreement-source figure (main text) | `scripts/build_v2_agreement_figure.py` | `figures/fig_v2_agreement_sources.png` |
| Operational integration of the agreement source: six policies (paper Table 9, Supplementary Table S4) | `scripts/build_v3_operational_agreement.py` | `results/v3_operational_agreement_all_viable_min100_full.csv`, `results/v3_operational_agreement_all_viable_min100_full_report.md` |
| Cost-matrix sensitivity of the policy ranking (paper Table 10) | `scripts/build_v3_cost_sensitivity.py` | `results/v3_cost_sensitivity_all_viable_min100_full.csv`, `results/v3_cost_sensitivity_all_viable_min100_full_report.md` |
| Ternary reliability weights, ternary conflict, and ternary-conflict-stratified policies (paper Table 11) | `scripts/build_v3_ternary_fusion.py` | `results/v3_ternary_fusion_all_viable_min100_full.csv`, `results/v3_ternary_fusion_weights_all_viable_min100_full.csv`, `results/v3_ternary_conflict_all_viable_min100_full.csv`, `results/v3_ternary_fusion_all_viable_min100_full_report.md` |
| Selective-deployment evaluation of the conformal rule | `scripts/build_v3_selective_deployment.py`, `scripts/build_v3_selective_gbc.py` | `results/v3_selective_deployment_all_viable_min100_full.csv`, `results/v3_selective_deployment_all_viable_min100_full_report.md`, `results/v3_selective_gbc_all_viable_min100_full_report.md` |
